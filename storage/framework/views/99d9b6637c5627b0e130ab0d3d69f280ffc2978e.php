...
<?php $__env->slot('title'); ?> Off Canvas <?php $__env->endSlot(); ?>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-title-desc">Responsive offcanvas classes are available across for each breakpoint.</p>
                ...
                <p class="card-title-desc mt-3 mb-2">Responsive offcanvas classes are available across for each breakpoint.</p>
                <ul class="mb-0 list-inline">
                    <li class="list-inline-item"><code>.offcanvas</code>,</li>
                    <li class="list-inline-item"><code>.offcanvas-sm</code>,</li>
                    <li class="list-inline-item"><code>.offcanvas-md</code>,</li>
                    <li class="list-inline-item"><code>.offcanvas-lg</code>,</li>
                    <li class="list-inline-item"><code>.offcanvas-xl</code>,</li>
                    <li class="list-inline-item"><code>.offcanvas-xxl</code></li>
                </ul>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\skot\resources\views/ui-offcanvas.blade.php ENDPATH**/ ?>