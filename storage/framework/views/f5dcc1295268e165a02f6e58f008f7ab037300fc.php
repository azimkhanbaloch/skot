                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle mb-0 table-nowrap">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row"><img
                                                                src="<?php echo e(URL::asset('/assets/images/product/img-1.png')); ?>"
                                                    ...
                                                    <tr>
                                                        <th scope="row"><img
                                                                src="<?php echo e(URL::asset('/assets/images/product/img-7.png')); ?>"
                                                                alt="product-img" title="product-img" class="avatar-md">
                                                        </th>
                                                        <td>
                                                            <h5 class="font-size-14 text-truncate"><a
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\skot\resources\views/ecommerce-checkout.blade.php ENDPATH**/ ?>