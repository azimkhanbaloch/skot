...
<head>
    ...
    <meta charset="utf-8" />
    <title><?php echo app('translator')->get('translation.ICO_Landing'); ?> | Skote - Admin & Dashboard Template</title>
    ...
    <nav class="navbar navbar-expand-lg navigation fixed-top sticky">
        <div class="container">
            <a class="navbar-logo" href="index">
                <img src="<?php echo e(URL::asset('/assets/images/logo-dark.png')); ?>" alt="" height="19" class="logo logo-dark">
                <img src="<?php echo e(URL::asset('/assets/images/logo-light.png')); ?>" alt="" height="19" class="logo logo-light">
            </a>
                    ...
                    <div class="owl-carousel owl-theme clients-carousel" id="clients-carousel" dir="ltr">
                        <div class="item">
                            <div class="client-images">
                                <img src="<?php echo e(URL::asset('/assets/images/clients/1.png')); ?>" alt="client-img" class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="item">
                            <div class="client-images">
                                <img src="<?php echo e(URL::asset('/assets/images/clients/2.png')); ?>" alt="client-img" class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="item">
                            <div class="client-images">
                                <img src="<?php echo e(URL::asset('/assets/images/clients/3.png')); ?>" alt="client-img" class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="item">
                            <div class="client-images">
                                <img src="<?php echo e(URL::asset('/assets/images/clients/4.png')); ?>" alt="client-img" class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="item">
                            <div class="client-images">
                                <img src="<?php echo e(URL::asset('/assets/images/clients/5.png')); ?>" alt="client-img" class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="item">
                            <div class="client-images">
                                <img src="<?php echo e(URL::asset('/assets/images/clients/6.png')); ?>" alt="client-img" class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH E:\xampp\htdocs\skot\resources\views/crypto-ico-landing.blade.php ENDPATH**/ ?>