...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?> Cart <?php $__env->endSlot(); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle mb-0 table-nowrap">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img src="<?php echo e(URL::asset('/assets/images/product/img-1.png')); ?>" alt="product-img" title="product-img"
                                            class="avatar-md" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <img src="<?php echo e(URL::asset('/assets/images/product/img-2.png')); ?>" alt="product-img" title="product-img"
                                            class="avatar-md" />
                                    </td>
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail"
                                ...
                                <tr>
                                    <td>
                                        <img src="<?php echo e(URL::asset('/assets/images/product/img-3.png')); ?>" alt="product-img" title="product-img"
                                            class="avatar-md" />
                                    </td>
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail"
                                ...
                                <tr>
                                    <td>
                                        <img src="<?php echo e(URL::asset('/assets/images/product/img-4.png')); ?>" alt="product-img" title="product-img"
                                            class="avatar-md" />
                                    </td>
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail"
                                ...
                                <tr>
                                    <td>
                                        <img src="<?php echo e(URL::asset('/assets/images/product/img-5.png')); ?>" alt="product-img" title="product-img"
                                            class="avatar-md" />
                                    </td>
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail"
                                ...
                                <tr>
                                    <td>
                                        <img src="<?php echo e(URL::asset('/assets/images/product/img-6.png')); ?>" alt="product-img" title="product-img"
                                            class="avatar-md" />
                                    </td>
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\skot\resources\views/ecommerce-cart.blade.php ENDPATH**/ ?>